...
motivation: 现有智能体强化学习受限于同策略探索，难以发现新的推理视角，且缺乏对细粒度步骤级探索动态的有效利用。
method: 提出两阶段框架，通过混合策略展开让智能体学习检索到的外部步骤，并利用检索感知优化机制校准策略梯度。
result: "在14个数据集上的实验显示，RAPO实现了5.0%的平均性能增益，并将训练效率提升了1.2倍。"
conclusion: RAPO通过将检索机制引入强化学习循环，有效扩展了智能体的探索空间，是提升LLM智能体推理能力的有效方案。
---
