...
motivation: 旨在解决单智能体在复杂长程导航任务中因认知过载而产生的感知失真和决策漂移问题。
method: 提出一种主从式多智能体协作框架，通过专门的观察、规划、执行和记忆智能体实现功能解耦，并结合双层反思机制进行动态优化。
result: 在真实世界室内数据集上的实验表明，MA-CoNav在多个指标上全面超越了现有的主流VLN方法。
conclusion: 该研究证明了通过多智能体协作和层级化功能解耦，可以有效提升具身智能体在长程复杂环境下的导航性能。
---
